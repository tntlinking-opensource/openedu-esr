...
@Results
	({ 
		...
		@Result(name="success",location="/ywmk/zrjspxqk-list.ftl",type = "freemarker"),
		@Result(name ="input",location="/ywmk/zrjspxqk-input.ftl", type = "freemarker"),
		@Result(name="tmimp",location="/ywmk/zrjspxqk-daor.ftl",type = "freemarker"),
...
public class ZrjspxqkAction extends CrudActionSupport<Zrjspxqk> {
	@Autowired
	protected ZrjspxqkService entityService;
	@Autowired
	protected DictService dictService;
	
	private List reqlist;
	private List<Dict> pxcclist;
	/*导入*/
	...
	public List<Dict> getPxcclist() {
		return pxcclist;
	}

	public void setPxcclist(List<Dict> pxcclist) {
		this.pxcclist = pxcclist;
	}
	...
	public String input() throws Exception {
		reqlist = dictService.findAllByDM("pxcc");
		return INPUT;
	}
	...
	public String list() throws Exception {
		...
		pxcclist = dictService.findAllByDM("pxcc");
	...
	protected void prepareModel() throws Exception {
		if (!StringUtils.isEmpty(id)) {
			entity = (Zrjspxqk) entityService.getById(id);
		} else {
			entity = new Zrjspxqk();
		}
	...
	{
		try {
			String  mbname	="专任教师培训情况Excel模板.xls";
			String scdz = "/zrjspxqk.xls";
