...
@Results
	({ 
		...
		@Result(name="success",location="/ywmk/xxsslx-list.ftl",type = "freemarker"),
		@Result(name ="input",location="/ywmk/xxsslx-input.ftl", type = "freemarker")
	})
public class XxsslxAction extends CrudActionSupport<Xxsslx> {
	@Autowired
	protected XxsslxService entityService;
	...
	protected void prepareModel() throws Exception {
		if (!StringUtils.isEmpty(id)) {
			entity = (Xxsslx) entityService.getById(id);
		} else {
			entity = new Xxsslx();
		}
