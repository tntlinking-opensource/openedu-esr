...
import org.pfw.framework.ywmk.dao.JzgxxDao;
...
@Service
@Transactional
public class JzgxxServiceImpl implements JzgxxService {

	@Autowired
	private JzgxxDao entityDao;

	@Transactional(readOnly=true)
	public Jzgxx getById(String id) {
	...
	@Transactional(readOnly=true)
	public List<Jzgxx> find(List<PropertyFilter> filters)
	{
		return entityDao.find(filters);
	}
	
	@Transactional(readOnly=true)
	public List<Jzgxx> find(List<PropertyFilter> filters, LinkedHashMap orderbyMap) {
		return entityDao.find(filters, orderbyMap);
	}
	
	public void save(Jzgxx entity)
	{
		entityDao.save(entity);
	}
	
	public void update(Jzgxx entity)
	{
	...
	@Override
	public List<Jzgxx> findAll()
	{
		return entityDao.find(" from Jzgxx r ");
	}
	
	@Override
	public List<Jzgxx> findbyhql(String hql, Object... val) 
	{
		return entityDao.find(hql, val);
	}
	
	@Override
	public List<Jzgxx> findBy(String propertyName, Object value,
			MatchType matchType) {
