...
import org.pfw.framework.ywmk.dao.SjrwDao;
...
@Service
@Transactional
public class SjrwServiceImpl implements SjrwService {

	@Autowired
	private SjrwDao entityDao;

	@Transactional(readOnly=true)
	public Sjrw getById(String id) {
	...
	@Transactional(readOnly=true)
	public List<Sjrw> find(List<PropertyFilter> filters)
	{
		return entityDao.find(filters);
	}
	
	@Transactional(readOnly=true)
	public List<Sjrw> find(List<PropertyFilter> filters, LinkedHashMap orderbyMap) {
		return entityDao.find(filters, orderbyMap);
	}
	
	public void save(Sjrw entity)
	{
		entityDao.save(entity);
	}
	
	public void update(Sjrw entity)
	{
	...
	@Override
	public List<Sjrw> findAll()
	{
		return entityDao.find(" from Sjrw r ");
	}
	
	@Override
	public List<Sjrw> findbyhql(String hql, Object... val) 
	{
		return entityDao.find(hql, val);
	}
	
	@Override
	public List<Sjrw> findBy(String propertyName, Object value,
			MatchType matchType) {
