...
import org.pfw.framework.ywmk.dao.JsskflqkDao;
...
@Service
@Transactional
public class JsskflqkServiceImpl implements JsskflqkService {

	@Autowired
	private JsskflqkDao entityDao;

	@Transactional(readOnly=true)
	public Jsskflqk getById(String id) {
	...
	@Transactional(readOnly=true)
	public List<Jsskflqk> find(List<PropertyFilter> filters)
	{
		return entityDao.find(filters);
	}
	
	@Transactional(readOnly=true)
	public List<Jsskflqk> find(List<PropertyFilter> filters, LinkedHashMap orderbyMap) {
		return entityDao.find(filters, orderbyMap);
	}
	
	public void save(Jsskflqk entity)
	{
		entityDao.save(entity);
	}
	
	public void update(Jsskflqk entity)
	{
	...
	@Override
	public List<Jsskflqk> findAll()
	{
		return entityDao.find(" from Jsskflqk r ");
	}
	
	@Override
	public List<Jsskflqk> findbyhql(String hql, Object... val) 
	{
		return entityDao.find(hql, val);
	}
	
	@Override
	public List<Jsskflqk> findBy(String propertyName, Object value,
			MatchType matchType) {
