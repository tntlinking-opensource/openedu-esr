      ...
      <nav class="navbar navbar-default" >
        <div class="topbar" style="">
          ...
          <div class="topbar-left" style="margin-left:0px;">
          	...
          	<!--
          	<span style="padding-left: 8px;border-left: 2px solid #ddd;height: 15px;">&nbsp;</span>
          	<span style="color: #fff;font-size: 15px;padding-left: 8px;">
          		教育事业统计报表系统
          	</span>
            ...
            <div id="breadcrumb" style="color:#999">首页</div>
            -->
          </div>
