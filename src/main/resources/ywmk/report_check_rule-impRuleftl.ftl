			...
			<div class="row-fluid">
				...
				<div class="span12">
					<div class="portlet box green">
						...
						<form id="form_inputForm" name="form_inputForm" class="form-horizontal" action="${base}/ywmk/report_check_rule!intoTopic.action" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<@s.file name="drfj" id="drfj" value="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		      								<a href="${base}/ywmk/report_check_rule!gzdrmbxz.action?doloadFlag=0" style="text-decoration:none;"><font color=red size=2>下载模板</font></a>
		      								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
