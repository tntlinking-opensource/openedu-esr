					...
					<div class="portlet box green">
						...
						<form id="save_inputForm" class="form-horizontal" action="${base}/ywmk/jzgxx!save.action" method="post">
							...
							<div class="row-fluid">
								...
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否接受过专业教育:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否心里健康教育教师:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
								...
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否双师:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否新进:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
								...
								<div class="span6">
									<div class="control-group" id="xjlxxz">
										<label class="control-label"><b>新进类型:</b></label>
										<div class="controls">
							...
							<div class="row-fluid">
								<div class="span6" id="sfyjbys">
									<div class="control-group" >
										<label class="control-label"><b>是否应届毕业生:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
								...
								<div class="span6" id="sfsfs">
									<div class="control-group" >
										<label class="control-label"><b>是否师范生:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
