				...
				<div class="span12">
					<div class="portlet box green">
						...
						<form id="save_inputForm" class="form-horizontal" action="${base}/ywmk/xsxx!save.action" method="post">
							...
							<#if xxlxstr?exists && (xxlxstr?contains('08zdjsxx') || xxlxstr?contains('07tzhzdzyxx') )>
								<div class="row-fluid">
									<div class="span6">
										<div class="control-group">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>招生中接受学前教育:</b><span class="required"></span></label>
										<div class="controls" >
											<span class="text">
												&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="zszjsxqjy"   value="0" <#if zszjsxqjy?exists & zszjsxqjy=='0'>checked<#else>checked</#if> >未接受 
												</label>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="zszjsxqjy"  value="1" <#if zszjsxqjy?exists & zszjsxqjy=='1'>checked</#if>>一年 
												</label>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="zszjsxqjy"  value="2" <#if zszjsxqjy?exists & zszjsxqjy=='2'>checked</#if>>两年
												</label>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="zszjsxqjy"  value="3" <#if zszjsxqjy?exists & zszjsxqjy=='3'>checked</#if>>三年
												</label>
											</span>
										</div>
									</div>
							...
							<div class="row-fluid">
								...
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否农村留守儿童:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="sfnclset" value="0"  <#if sfnclset?exists && sfnclset == '0'>checked<#else>checked</#if>>否
												</label>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="sfnclset" value="1"  <#if sfnclset?exists && sfnclset == '1'>checked</#if>>是
												</label>
											</span>
										</div>
									</div>
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="control-group">
										<label class="control-label"><b>是否随班就读:</b></label>
										<div class="controls">
											<span class="text">
												<label class="radio">
													&nbsp;&nbsp;&nbsp;
													<input type="radio" name="sfsbjd" value="0"  <#if sfsbjd?exists && sfsbjd == '0'>checked<#else>checked</#if>>否
												</label>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<label class="radio">
													<input type="radio" name="sfsbjd" value="1"  <#if sfsbjd?exists && sfsbjd == '1'>checked</#if>>是
												</label>
											</span>
										</div>
									</div>
