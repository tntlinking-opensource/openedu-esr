...
<@crudmetropage3>
	<form id="query_form" action="${base}/ywmk/dict_three.action" method="post">
						...
						<div class="portlet">
							...
							<div class="portlet-body">
								...
								<#list page.result as obj>
									...
									<tr titl="${obj.id}">
										...
										<td>
										 ...
										 <td>
											<center>
									 			<a class="oprt-a" href="javascript:;" onclick="window.open('${base}/ywmk/dict_three!input.action?id=${obj.id}')"> 修改</a>
											</center>
										 </td>
									</tr>
								</#list>
								...
								<script type="text/javascript">
									...
									function add()
									{
											window.open('${base}/ywmk/dict_three!input.action');
									}
									...
									$('#query_form').pfwpage({
										page_button:[
											...
											{b_name:'删除',opttype:'delete',bclass:'btn redbtn',bicon:'icon-trash',b_url:'${base}/ywmk/dict_three!delete.action',confirmStr:'是否确认删除？',paramName:'checks',selectNum:'^[0-9]*[1-9][0-9]*$'}
										],
										page_col:
										[
