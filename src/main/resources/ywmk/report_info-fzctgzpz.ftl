...
<@crudmetropage3>
	...
	<h3 class="form-section">复制填充规则配置
		<span>请选择</span>
								...
								<script type="text/javascript">
									...
									function baoc(){
										...
										if(leftSize === rightSize){
											...
											var url = '${base}/ywmk/report_info!insertfztcgzpz.action';
											var bbid = "${entity.id!}";
									...
									function tdclick(obj){ 
								 	...
								 	$(document).ready(function() {
										...
										nowinitcheckbox()
										<#if entity.fztcgzpz?exists && entity.fztcgzpz != ''>
										
											var jsonstr = JSON.parse('${entity.fztcgzpz!}');
