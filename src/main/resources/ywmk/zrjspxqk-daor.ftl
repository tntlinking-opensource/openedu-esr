			...
			<div class="row-fluid">
				...
				<div class="span12">
					<div class="portlet box green">
						...
						<!--内容表单-->
						<form id="form_inputForm" name="form_inputForm" class="form-horizontal" action="${base}/ywmk/zrjspxqk!daorxx.action" method="post" enctype="multipart/form-data">
							<div class="row-fluid">
								<div class="span1"></div>
								<div class="span10">
									<div class="control-group">
										...
										<div class="controls">
											<@s.file name="drfj" id="drfj" value="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		      								<a href="${base}/ywmk/zrjspxqk!daor.action?doloadFlag=0" style="text-decoration:none;"><font color=red size=2>下载模板</font></a>
		      								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
