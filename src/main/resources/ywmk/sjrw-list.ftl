...
<@crudmetropage3>
	<form id="query_form" action="${base}/ywmk/sjrw.action" method="post">
		...
		<div class="row-fluid cpquery">
			  	...
			  	<div class="span2">
					...
					<input type="text" class="m-wrap span12" id="filter_LIKES_nianf" name="filter_LIKES_nianf"  value="${Parameters['filter_LIKES_nianf']?if_exists}" maxlength="50"/>
			  	</div>
							...
							<div class="portlet-body">
								...
								<#list page.result as obj>
									...
									<tr titl="${obj.id}">
										 ...
										 <td>
								 			<a class="oprt-a" href="javascript:;" onclick="window.open('${base}/ywmk/sjrw!input.action?id=${obj.id}')">修改</a>
								 			&nbsp;&nbsp;&nbsp;
								 			<a class="oprt-a" href="javascript:;" onclick="window.open('${base}/ywmk/xxbbxx.action?sjrwid=${obj.id}')">配置操作</a>
										 </td>
									</tr>
								</#list>
								</table>		
								...
								<script type="text/javascript">
									...
									function add()
									{
										window.open('${base}/ywmk/sjrw!input.action');
									}
									...
									$('#query_form').pfwpage({
										page_button:[
											...
											{b_name:'删除',opttype:'delete',bclass:'btn redbtn',bicon:'icon-trash',b_url:'${base}/ywmk/sjrw!delete.action',confirmStr:'是否确认删除？',paramName:'checks',selectNum:'^[0-9]*[1-9][0-9]*$'}
										],
										page_col:
										[
