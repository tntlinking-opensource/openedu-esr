...
<@crudmetropage3>
	<form id="query_form" action="${base}/ywmk/xxxq.action" method="post">
		...
		<div class="row-fluid cpquery">
			  	<div class="span2">
					...
					<input type="text" class="m-wrap span12" id="filter_LIKES_xqdm" name="filter_LIKES_xqdm"  value="${Parameters['filter_LIKES_xqdm']?if_exists}" maxlength="50"/>
			  	</div>
			  	<div class="span2">
			  		<label class="control-label">
						校区名称:
					</label>
					<input type="text" class="m-wrap span12" id="filter_LIKES_xqmc" name="filter_LIKES_xqmc"  value="${Parameters['filter_LIKES_xqmc']?if_exists}" maxlength="100"/>
			  	</div>
			  	<div class="span2">
			  		<label class="control-label">
						校区地址:
					</label>
					<input type="text" class="m-wrap span12" id="filter_LIKES_xqdz" name="filter_LIKES_xqdz"  value="${Parameters['filter_LIKES_xqdz']?if_exists}" maxlength="200"/>
			  	</div>
			  	<div class="span2">
			  		<label class="control-label">
						是否有效:
						...
						<div class="portlet">
							...
							<div class="portlet-body">
								...
								<#list page.result as obj>
									...
									<tr titl="${obj.id}">
										<td>
										 ...
										 <td>
											<center>
									 			<a class="oprt-a" href="javascript:;" onclick="window.open('${base}/ywmk/xxxq!input.action?id=${obj.id}')"> 修改</a>
								...
								<script type="text/javascript">
									...
									function add()
									{
											window.open('${base}/ywmk/xxxq!input.action');
									}
									...
									$('#query_form').pfwpage({
										page_button:[
											...
											{b_name:'删除',opttype:'delete',bclass:'btn redbtn',bicon:'icon-trash',b_url:'${base}/ywmk/xxxq!delete.action',confirmStr:'是否确认删除？',paramName:'checks',selectNum:'^[0-9]*[1-9][0-9]*$'}
										],
										page_col:
										[
