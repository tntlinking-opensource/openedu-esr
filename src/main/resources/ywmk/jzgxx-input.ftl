						...
						<form id="save_inputForm" class="form-horizontal" action="${base}/ywmk/jzgxx!save.action" method="post">
							...
							<div class="row-fluid">
								<div class="span12" id="bxnsfsk">
									...
									<div class="span6">
										<div class="control-group" id="sftjzrjs">
											<label class="control-label"><b>是否特教专任教师:</b><span class="required">*</span></label>
											<div class="controls">
												<span class="text">
													<label class="radio">
														&nbsp;&nbsp;&nbsp;
														<input type="radio" name="sftjzrjs" value="0"  <#if sftjzrjs?exists && sftjzrjs == '0'>checked<#else>checked</#if>>否
													</label>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<label class="radio">
														<input type="radio" name="sftjzrjs" value="1"  <#if sftjzrjs?exists && sftjzrjs == '1'>checked</#if>>是
													</label>
												</span>
											</div>
										</div>
							...
							<!--<#--
							<div class="row-fluid">
								<div class="span6" id="gzjyid">
									<div class="control-group" >
										<label class="control-label"><b>高中教育-人教课程:</b></label>
										<div class="controls">
											<select name="gzjyrjkc.id" class="m-wrap span10">
												<option value="">==请选择==</option>
												<#if gzjyList?exists>
													<#list gzjyList as obj>
														<option value="${obj.id}"  <#if gzjyrjkc?exists && gzjyrjkc.id?exists && gzjyrjkc.id == obj.id>selected</#if> >${obj.name}</option>
													</#list>
												</#if>
											</select>
										</div>
							...
							<div class="row-fluid" >
								...
								<#if bxlxstr?exists && (bxlxstr?contains('02xiaox') ||bxlxstr?contains('030chujzx') || bxlxstr?contains('040jnygz') || bxlxstr?contains('050wqzx')|| bxlxstr?contains('051gaojzx') || bxlxstr?contains('052shienygz'))>
								<div class="span6" >
									<div class="control-group" >
								...
								<#if bxlxstr?exists && (bxlxstr?contains('08zdjsxx') ||bxlxstr?contains('07tzhzdzyxx'))>
									<div class="span6" >
										<div class="control-group" >
											<label class="control-label"><b>任教大类:</b></label>
											<div class="controls">
												<select name="zyjyrjdl.id" class="m-wrap span10">
													<option value="">==请选择==</option>
													<#if zyjyList?exists>
														<#list zyjyList as obj>
															<option value="${obj.id}"  <#if zyjyrjdl?exists && zyjyrjdl.id?exists && zyjyrjdl.id ==obj.id>selected</#if> >${obj.name}</option>
														</#list>
													</#if>
												</select>
											</div>
									...
									<div class="span6">
										<div class="control-group" >
											<label class="control-label"><b>是否实习指导课教师:</b></label>
											<div class="controls">
												<span class="text">
													&nbsp;&nbsp;&nbsp;&nbsp;
													<label class="radio">
														<input type="radio" name="sfsxzdkjs"   value="0" <#if sfsxzdkjs?exists && sfsxzdkjs=='0'>checked<#else>checked</#if> >否
													</label>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<label class="radio">
														<input type="radio" name="sfsxzdkjs"  value="1" <#if sfsxzdkjs?exists && sfsxzdkjs=='1'>checked</#if>>是
													</label>
												</span>
											</div>
										</div>
								...
								var xxkmSelect = document.getElementById("xxkmid");
									...
									if (tmpval === "艺术" || tmpval === "外语" || tmpval === "技术"){
										...
										if (tmpval == "外语") {
											...
											xxkmSelect.innerHTML = "<option value=''>请选择技术科目</option><option value='6' <#if xxkm?exists && xxkm== '6'>selected</#if> >信息技术</option><option value='7' <#if xxkm?exists && xxkm== '7'>selected</#if> >通用技术</option>";
										}
									}else{
