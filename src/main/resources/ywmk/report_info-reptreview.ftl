...
<@crudmetropage3>
	...
	<div style="min-height:1200px">
		...
		<p/>
			...
			<div style="position: fixed;bottom: 25px;width: 97%;text-align: center;">
				...
				&nbsp;
				&nbsp;
				<button class="btn big blue" type="button" onclick="expExcle()">导出填报结果</button>
				&nbsp;
				&nbsp;
				<button class="btn big blue" type="button" onclick="impExcle()">导入</button>
			</div>	
