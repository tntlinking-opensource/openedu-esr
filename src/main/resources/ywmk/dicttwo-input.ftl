...
<#if id?exists>
	<#assign extPosition='修改数据字典(二级)'/>
<#else>
	<#assign extPosition='创建数据字典(二级)'/>
</#if>
				...
				<div class="span12">
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							<!--内容表单-->
							<form id="save_inputForm" class="form-horizontal" action="${base}/ywmk/dict_two!save.action" method="post">
								<@s.token />
								<#if id?exists>
