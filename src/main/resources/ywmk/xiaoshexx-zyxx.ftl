					...
					<div class="portlet box green">
						...
						<form id="save_inputForm" class="form-horizontal" action="${base}/ywmk/xiaoshexx!save.action" method="post">
							...
							<#if bxlxstr?exists && (bxlxstr?contains('08zdjsxx') ||bxlxstr?contains('07tzhzdzyxx'))>
								<div class="control-group">
									<label class="control-label"><b>是否正在施工:</b><span class="required">*</span></label>
									<div class="controls">
										<span class="text">
											<label class="radio">
												&nbsp;&nbsp;&nbsp;
												<input type="radio" name="sfzzsg" value="0"  <#if sfzzsg?exists && sfzzsg == '0'>checked<#else>checked</#if>>否
											</label>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<label class="radio">
												<input type="radio" name="sfzzsg" value="1"  <#if sfzzsg?exists && sfzzsg == '1'>checked</#if>>是
											</label>
										</span>
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label"><b>是否有产权:</b><span class="required">*</span></label>
									<div class="controls">
										<span class="text">
											<label class="radio">
												&nbsp;&nbsp;&nbsp;
												<input type="radio" name="sfycq" value="1"  <#if sfycq?exists && sfycq == '1'>checked<#else>checked</#if>>是
											</label>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<label class="radio">
												<input type="radio" name="sfycq" value="0"  <#if sfycq?exists && sfycq == '0'>checked</#if>>否
											</label>
										</span>
									</div>
								</div>
